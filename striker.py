...
if not os.geteuid() == 0:
    sys.exit('HF must be run as root')
 ...
 #$$W    `$$$#"            "       !$$$$$`           `"#$$$$$$$$$$#
  ...
  #$$    $u                  $   $$$$$$$                  $$$$$$$~
   "#    #$$i.               #   $$$$$$$.                 `$$$$$$
         ...
         $$$$$$$$$$`                    $$$$$$$$$Wi$$$$$$#"#$$`
         #$$$$$$$$$W.                   $$$$$$$$$$$#   ``
          `$$$$##$$$$!       i$u.  $. .i$$$$$$$$$#""''' + WHITE + '''   Hacking Framework''' + RED + '''
             "     `#W       $$$$$$$$$$$$$$$$$$$`      u$#
                            W$$$$$$$$$$$$$$$$$$      $$$$W
                            $$`!$$$##$$$$``$$$$      $$$$!
                           i$" $$$$  $$#"`  """     W$$$$
...
def mess():
    ...
    print '- {0}Run HF modules{1} - {0}[{1}view available modules on help message{0}]{1}: '.format(BLUE, END)
...
def main():
    try:
        while 1:
     # enter shell command
            header = ('{0}HF{1} > {2}'.format(RED, WHITE, END))
